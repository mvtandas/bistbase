export interface StockDetail {
  ...
  macroData: { usdTry: number | null; usdTryChange: number | null; bist100: number | null; bist100Change: number | null; dxy: number | null; dxyChange: number | null; vix: number | null; macroScore: number; macroLabel: string } | null;
